        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center mb-4">
              <span className="text-health-blue font-bold text-2xl">Health</span>
              <span className="text-health-green font-bold text-2xl">Hub</span>
            </Link>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/articles?category=cardiovascular" className="text-gray-300 hover:text-white">
                  Cardiovascular Health
                </Link>
              </li>
              <li>
                <Link to="/articles?category=diabetes" className="text-gray-300 hover:text-white">
                  Diabetes Management
                </Link>
              </li>
              <li>
                <Link to="/articles?category=mental-health" className="text-gray-300 hover:text-white">
                  Mental Health
                </Link>
              </li>
              <li>
                <Link to="/articles?category=nutrition" className="text-gray-300 hover:text-white">
                  Nutrition & Diet
                </Link>
              </li>
              <li>
                <Link to="/articles?category=fitness" className="text-gray-300 hover:text-white">
                  Fitness & Exercise
                </Link>
              </li>
              <li>
                <Link to="/articles?category=preventive-care" className="text-gray-300 hover:text-white">
                  Preventive Care
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-4">
              <li className="flex">
                <MapPin className="h-6 w-6 text-health-blue mr-2" />
                <span>123 Health Street, Medical City, MC 12345</span>
              </li>
              <li className="flex">
                <Phone className="h-6 w-6 text-health-blue mr-2" />
                <span>+1 (555) 123-4567</span>
              </li>
              <li className="flex">
                <Mail className="h-6 w-6 text-health-blue mr-2" />
